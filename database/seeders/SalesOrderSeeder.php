    ...
    public function run(): void
    {
        ...
        DB::table('sales_orders')->insert([
            [
                ...
                'customer_address'   => 'Jl. Industri Raya No.12, Kel. Kaliabang Tengah, Kec. Bekasi Utara, Kota Bekasi, Jawa Barat 17125',
                'customer_po_number' => 'PO-MSA-2026-0045',
                'status'             => 'OPEN',
                'created_at'         => now(),
                'updated_at'         => now(),
            ],
            [
                ...
                'customer_address'   => 'Jl. Raya Serpong No.45, Kel. Pakualam, Kec. Serpong Utara, Kota Tangerang Selatan, Banten 15320',
                'customer_po_number' => 'PO-BT-2026-0012',
                'status'             => 'OPEN',
                'created_at'         => now(),
                'updated_at'         => now(),
            ],
            [
                ...
                'customer_address'   => 'Jl. Gatot Subroto Kav.88, Kel. Kuningan Timur, Kec. Setiabudi, Kota Jakarta Selatan, DKI Jakarta 12950',
                'customer_po_number' => 'PO-GN-2026-0007',
                'status'             => 'OPEN',
                'created_at'         => now(),
                'updated_at'         => now(),
            ],
